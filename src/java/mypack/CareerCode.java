...
String query=("insert into career values('"+name+"','"+gender+"','"+address+"','"+contactno+"','"+emailaddress+"','"+Qualification+"','"+experience+"','"+keyskills+"','"+(emailaddress+filename)+"','"+db.getDate()+"')");
...
File  f= new File(request.getRealPath("/upload"),(emailaddress+filename));
 ...
 response.getWriter().print("<script>alert('successful');window.location.href='index.jsp';</script>");
}
else{
     response.getWriter().print(" <script>alert('un successful');window.location.href='index.jsp';</script>");
}
    }
catch(Exception e)
{
