...
{
out.print("<script>alert('vendor reg SUCCESSFUL');window.location.href='../index.jsp';</script>");
}
else
{
out.println("<script>alert('not SUCESSFUL');window.location.href='../index.jsp';</script>");
}
%>